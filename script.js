...
/* 15 ДЗ Написать цепочку наследования классов, минимум из трёх уровней, постепенно расширяя список свойств и, возможно, методов. Взять любой пример из реальной жизни. Применить любой из понятных синтаксисов.
